(function () {
  ...
  var FRIEND_ENCRYPT_FIELDS = ["名前", "ふりがな", "LINE名", "Instagramアカウント名", "Instagram URL", "年齢差", "生年月日", "性別", "職業", "出会った日", "出会った場所", "出身", "居住地", "居住形態", "更新月", "職場", "趣味", "家族構成", "話したこと", "提案対象", "最新連絡日", "その他", "今後の予定"];
